...
/**
 ...
 nonisolated
 struct FilmDataTransferObject: Sendable {
    init(film: Film) {
...
nonisolated // opt out of the @MainActor for testingpurposes
...
//        MockGhibliService().fetchFilm()
        let bannerURL = URL.convertAssetImage(named: "MyNeighborTotoroDetail")
        let listURL = URL.convertAssetImage(named: "MyNeighborTotoroList")
    ...
    @MainActor
    static var previewFavorite: Film {
//        MockGhibliService().fetchFilm()
        let bannerURL = URL.convertAssetImage(named: "MyNeighborTotoroDetail")
        let listURL = URL.convertAssetImage(named: "MyNeighborTotoroList")
